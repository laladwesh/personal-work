...
const PricePage = () => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    // Define a unique identifier for your page (e.g., URL or pathname)
    const currentPage = window.location.pathname; // Or use a unique identifier

    // Check if the page is refreshed
    if (
      performance.navigation.type === 1 &&
      currentPage === "/your-specific-page"
    ) {
      console.log("Page was refreshed, and it's the specific page!");
      // Perform your task here
      executeMyTask();
    } else {
      console.log("Page loaded normally or is not the specific page.");
  ...
  function executeMyTask() {
    ...
    alert("Task executed because you refreshed the page!");
  }
